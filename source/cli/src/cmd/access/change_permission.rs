...
use crate::{
    cmd::{self, RequestChangePermissionsForAccessKey},
...
pub async fn change_permission(
    ...
    let response: Response = session::send_request(cmd::Request::ChangePermissionForAccessKey(
        RequestChangePermissionsForAccessKey {
            vault,
            access_key,
